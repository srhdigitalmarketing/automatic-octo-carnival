...
Jangan hapus traffic_daily_player_metrics (impressions/play clicks harian), video_daily_views (popularitas per periode), atau live_traffic (pengunjung aktif). Tabel kosong untuk series, seasons, translations, requests dan relasi masih dirujuk oleh model/fitur aplikasi; jumlah baris nol bukan bukti aman dihapus.
