<?php $isExisting = !empty($tpAPI->id); $providerName = $tpAPI->provider === 'streamhg' ? 'StreamHG' : 'UPNShare'; ?>
<div class="x_panel host-api-form-panel"><div class="x_content">
    ...
    <?php if ($tpAPI->provider === 'streamhg'): ?><p>Website akun: streamhg.com. Endpoint API: https://streamhgapi.com/api. Gunakan API key dari akun StreamHG Anda.</p><?php endif ?>
