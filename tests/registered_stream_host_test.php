...
namespace App\Models {
 class ThirdPartyApi {
  ...
  public function whereIn($field,$values){if($field!=='provider' || $values!==['upnshare','custom_http','vod_catalog'])throw new \RuntimeException('Unexpected providers');return $this;}
  ...
  public function findAll(){self::$calls++;return [(object)['embed_domains'=>'ustreamplay.online, upload18.org']];}
 }
}
namespace {
 require __DIR__.'/../app/Libraries/VideoHostHealth.php';require __DIR__.'/../app/Libraries/RegisteredStreamHost.php';
 foreach(['https://ustreamplay.online/#123'=>true,'https://UPLOAD18.ORG/a'=>true,'https://abcdomain.org/play/a'=>false,'https://upload18.org.evil.test/a'=>false,'https://evil.test/upload18.org'=>false,'https://upload18.org@evil.test/a'=>false,''=>false,'ftp://upload18.org/a'=>false] as $url=>$expected){if(\App\Libraries\RegisteredStreamHost::matches($url)!==$expected)throw new \RuntimeException('Wrong host decision: '.$url);}
